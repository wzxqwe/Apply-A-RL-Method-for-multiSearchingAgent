...
class PositionSearchProblem(search.SearchProblem):
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            dest_x, nexty = int(x + dx), int(y + dy)
            if not self.walls[dest_x][nexty]:
                nextState = (dest_x, nexty)
...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        # init all conoers not visited as 0 (if visited 1)
        self.initialState = [0]*4
    ...
    def getSuccessors(self, state):
        """
        similar to search , node contain path state cost
        """
        successors = []
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[dest_x][nexty]:
                ...
                if (dest_x,nexty) in self.corners:
                    visited_cor[self.corners.index((dest_x,nexty))] = 1 # This corner is visited

                nextState = ((dest_x, nexty), visited_cor) # Fix new state
                cost = 1
    ...
    def getSuccessors(self, state):
        ...
        for direction in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[dest_x][nexty]:
                ...
                nextFood[dest_x][nexty] = False
                successors.append( ( ((dest_x, nexty), nextFood), direction, 1) )
        return successors
